...
- отдельное сочетание для каждого профиля с автоматическим разрешением конфликтов;
- интерфейс на русском и английском с переключением без перезапуска;
...
Профили, кроме системного профиля **Default**, сначала получают сочетания по
порядку. Затем каждое назначение можно изменить или отключить в разделе
**Настройки → Глобальные сочетания**:
